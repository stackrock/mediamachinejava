...
public class SummaryJobBuilderTest {
    ...
    void throwExceptionIfNoInputUrlAndNoInputBlob() {
        ...
        IllegalStateException thrown = assertThrows(IllegalStateException.class, () -> {
            SummaryJobBuilder sjb = client.summaryGifJob().webhooks(FAKE_WEBHOOKS).to(FAKE_OUTPUT_URL);
            sjb.execute();
    ...
    void throwExceptionIfNoOutputUrlAndNoOutputlob() {
        ...
        IllegalStateException thrown = assertThrows(IllegalStateException.class, () -> {
            SummaryJobBuilder sjb = client.summaryMp4Job().webhooks(FAKE_WEBHOOKS).from(FAKE_INPUT_URL);
            sjb.execute();
        }, "Expected Summary to throw, but it didn't");
    ...
    @Test
    void throwExceptionIfNoType() {
        MediaMachine client = new MediaMachine(FAKE_API_KEY);

        IllegalStateException thrown = assertThrows(IllegalStateException.class, () -> {
            SummaryJobBuilder sjb = client.summaryMp4Job().type(null).webhooks(FAKE_WEBHOOKS).from(FAKE_INPUT_URL).to(FAKE_OUTPUT_URL);
            sjb.execute();
        }, "Expected Summary to throw, but it didn't");
    ...
    @Test
    void successMp4IfValidArgumentsWithInputUrlAndOutputUrlWithNoWatermark() {
        ...
        SummaryJobBuilder sjb = client.summaryMp4Job().setApi(fakeApi).webhooks(FAKE_WEBHOOKS).from(FAKE_INPUT_URL).to(FAKE_OUTPUT_URL).removeAudio(true);
        assertDoesNotThrow(() -> {
            sjb.execute();
        }, "Should not throw an exception");
        Map<String, Object> fakeApiJsonMap = gson.fromJson(fakeApi.getBody(), Map.class);
        assertEquals(expectedJsonMap, fakeApiJsonMap);
        assertEquals(fakeApi.getJobType(), "mp4_summary");
    }

    @Test
    void successMp4IfValidArgumentsWithInputS3AndOutputS3WithNoWatermark() {
        String expectedJsonStr = """
        {
            "apiKey": "test-123",
    ...
    @Test
    void successMp4IfValidArgumentsWithInputGcpAndOutputGcpWithNoWatermark() {
        String expectedJsonStr = """
        {
            "apiKey": "test-123",
    ...
    @Test
    void successMp4IfValidArgumentsWithInputAzureAndOutputAzureWithNoWatermark() {
        String expectedJsonStr = """
        {
            "apiKey": "test-123",
    ...
    @Test
    void successMp4IfValidArgumentsWithInputUrlAndOutputUrlWithTextWatermark() {
        String expectedJsonStr = """
        {
            "apiKey": "test-123",
            "inputUrl": "http://mediamachine.io/path/to/video.mp4",
    ...
    @Test
    void successMp4IfValidArgumentsWithInputUrlAndOutputUrlWithImageUrlWatermark() {
        String expectedJsonStr = """
        {
            "apiKey": "test-123",
            "inputUrl": "http://mediamachine.io/path/to/video.mp4",
    ...
    @Test
    void successMp4IfValidArgumentsWithInputUrlAndOutputUrlWithNamedImageWatermark() {
        String expectedJsonStr = """
        {
            "apiKey": "test-123",
            "inputUrl": "http://mediamachine.io/path/to/video.mp4",
    ...
    @Test
    void successMp4IfValidArgumentsWithInputUrlAndOutputUrlWithCustomWidthAndNoWatermark() {
        String expectedJsonStr = """
        {
            "apiKey": "test-123",
            "inputUrl": "http://mediamachine.io/path/to/video.mp4",
        ...
        SummaryJobBuilder sjb = client.summaryMp4Job().setApi(fakeApi).webhooks(FAKE_WEBHOOKS).from(FAKE_INPUT_URL).to(FAKE_OUTPUT_URL).removeAudio(true).width(1024);
        assertDoesNotThrow(() -> {
            sjb.execute();
        }, "Should not throw an exception");
        Map<String, Object> fakeApiJsonMap = gson.fromJson(fakeApi.getBody(), Map.class);
    ...
    @Test
    void successGifIfValidrgumentsWithInputUrlAndOutputUrlWithCustomWidthAndNoWatermark() {
        String expectedJsonStr = """
        {
            "apiKey": "test-123",
            "inputUrl": "http://mediamachine.io/path/to/video.mp4",
        ...
        SummaryJobBuilder sjb = client.summaryGifJob().setApi(fakeApi).webhooks(FAKE_WEBHOOKS).from(FAKE_INPUT_URL).to(FAKE_OUTPUT_URL).removeAudio(true).width(1024);
        assertDoesNotThrow(() -> {
            sjb.execute();
        }, "Should not throw an exception");
        Map<String, Object> fakeApiJsonMap = gson.fromJson(fakeApi.getBody(), Map.class);
        assertEquals(expectedJsonMap, fakeApiJsonMap);
        assertEquals(fakeApi.getJobType(), "gif_summary");
    }
}
